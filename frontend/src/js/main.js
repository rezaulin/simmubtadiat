    ...
    <div class="relative z-10">
      <div class="flex justify-between items-start gap-4">
        ...
        <div class="flex items-center gap-2 shrink-0">
          <div id="user-avatar" class="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-white/15 border border-white/25 backdrop-blur-md shadow-lg shrink-0 overflow-hidden"><img src="/logo-v2.png" alt="Logo Madrasah" class="w-full h-full object-contain p-0.5"></div>
        </div>
      </div>
  ...
  try {
    ...
    if (document.getElementById('user-greeting')) {
      ...
      if (avatar && !avatar.querySelector('img')) {
        avatar.innerHTML = '<img src="/logo-v2.png" alt="Logo Madrasah" class="w-full h-full object-contain p-0.5">';
      }
