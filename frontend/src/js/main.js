...
function renderMenuGrid(roles, target) {
  ...
  function draw() {
    ...
    el.innerHTML = `
      <div class="text-white rounded-3xl p-4 shadow-xl shadow-teal-900/20 dark:shadow-none md:p-5 relative overflow-hidden" style="background-image: url('/hero-pattern.jpg'); background-size: cover; background-position: center;">
        <div class="absolute inset-0 pointer-events-none rounded-3xl" style="background: linear-gradient(135deg, rgba(15,110,119,0.70), rgba(18,162,168,0.65))"></div>
        ${tabsHtml}
