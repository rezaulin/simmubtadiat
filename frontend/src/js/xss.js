...
const MENU_ACCESS = {
  ...
  muroqib: ['/index.html', '/santri.html', '/absensi-manual.html', '/catatan.html', '/dewan-harian.html', '/pengajar.html', '/rekap.html'],
...
const BOTTOM_NAV = {
  beranda: { href: '/index.html', icon: 'home', label: 'Beranda' },
  // --- Per-role nav (Beranda + 2 role-specific) ---
  pimpinan: [
